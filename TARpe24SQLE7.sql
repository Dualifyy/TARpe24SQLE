...
select square(3) --kõik tehtemärgid on deterministlikud, sinna kuuluvad veel sum, avg, square
...
--1. lokaalsed ajutised tabelid on ühe # märgiga, aga gloaalsel on kaks tükki
...
--ajutised tabelid lõpetatakse viimane viitav ühendus kinni pandud.
...
-- klastris olevad indeksid dikteerivad säilitatud andmete järjstuse tabelis
-- ja seda saab klastrite puhul olla ainult üks

create clustered index IX_EmployeeCity_Name
on EmployeeCity(Name)

--annab veateate, et tabelis saab olla ainult üks index
...
--indeks on eemaldatud nüüd käivitame selle uuesti
...
--väärtuste unikaalsust (sh privaatvõtme oma)