...
--loeb ära tabeli olevate ridade arvu
...
-- kõik kes teenivad palka üle 4k
...
-- left join
-- kuidas saada kõik andmed Employees kätte
select Name, Gender, Salary, DepartmentName
from Employees
left join Department
on Employees.DepartmentId = Department.Id
...
select Name, Gender, Salary, DepartmentName
from Employees
right join Department -- võib kasutada RIGHT OUTER JOIN-i
on Employees.DepartmentId = Department.Id

-- kuidas saada kõikide väärtused ühte päringusse
